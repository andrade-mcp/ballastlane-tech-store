...
{
    o.SwaggerDoc("v1", new OpenApiInfo { Title = "BallastlaneTechStore API", Version = "v1" });
...
// Default policy: every controller endpoint requires a bearer unless [AllowAnonymous].
...
public partial class StoreApiProgram;
